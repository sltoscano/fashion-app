...
void graphcut(Mat& featureVec, Mat& im, int num_lables) {
	...
	gc->setSmoothCostVH((GCoptimization::EnergyTermType*)(Sc.data),(GCoptimization::EnergyTermType*)grayInt.data,(GCoptimization::EnergyTermType*)grayInt1.data);
...
void graphcut1(Mat& im, Mat& probs, Mat& dx, Mat& dy,int num_lables,Mat& lables /*= Mat()*/) {
	...
	//				50,0,50,
	//				50,50,0};
	gc.setSmoothCostVH((GCoptimization::EnergyTermType *)(/*score*/Sc.data),(GCoptimization::EnergyTermType *)dx.data,(GCoptimization::EnergyTermType *)dy.data);
